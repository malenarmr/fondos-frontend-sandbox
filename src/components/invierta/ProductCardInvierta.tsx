...
const ProductCard: React.FC<ProductCardProps> = ({
  ...
  return (
    <div
      className="rounded-tl-md rounded-tr-[20px] rounded-br-md rounded-bl-[20px] py-40 px-10 shadow-md flex justify-center items-center text-center transition-colors duration-500 ease-in-out overflow-hidden w-[350px] h-[324px] min-w-[350px] min-h-[324px]"
      style={{
