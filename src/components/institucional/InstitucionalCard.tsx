...
export default function InstitucionalCard({
  ...
  return (
    <div className="bg-white p-6 rounded-tl-[8px] rounded-br-[8px] rounded-tr-[22px] rounded-bl-[22px] md:shadow-md w-full mx-auto transition-transform transform hover:scale-105 hover:shadow-lg">
