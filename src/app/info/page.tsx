...
export default function InfoPage() {
  return (
    <main>
      ...
      <section className="bg-[#2098A1] py-16 dark:bg-dark md:px-[100px] xl:px-[145px]">
        <div className="flex flex-col-reverse xl:flex-row items-center justify-between mx-auto">
          <div className="flex flex-col text-primary">
            <h1 className="text-center xl:text-left font-encode-sans font-bold xl:font-black text-2xl xl:text-[45px] leading-[30px] xl:leading-[60px] text-primary mb-7 xl:mb-12 max-w-[555px] text-white">
